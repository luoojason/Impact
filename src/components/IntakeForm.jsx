  ...
  return (
    <main className={styles.page}>
      <div className={styles.hero}>
        <div className={styles.heroEyebrow}>Global Investment Intelligence</div>
        <h1 className={styles.heroTitle}>
          Renewable Energy<br /><em>Opportunity Analysis</em>
        </h1>
        <p className={styles.heroSub}>
          AI-powered analysis of emerging market opportunities — climate risk, conflict data, regulatory landscape, and comparable projects in seconds.
        </p>
      </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.field}>
              ...
              <input
                ...
                required
                placeholder="Acme Energy Partners"
              />
            </div>
            <div className={styles.field}>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                placeholder="Brief description of your fund or company"
              />
            </div>
            <div className={styles.field}>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={2}
                placeholder="List any existing investments"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.field}>
              ...
              <input
                ...
                value={form.geoFocus}
                onChange={handleChange}
                placeholder="Kenya, Nigeria, Brazil"
                required
              />
            </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.field}>
              ...
              <div className={styles.riskGroup}>
                {['low', 'medium', 'high'].map((r) => (
                  <label
                    key={r}
                    className={`${styles.riskOption} ${form.riskTolerance === r ? styles.riskActive : ''}`}
                  >
                    <input
                      type="radio"
                      name="riskTolerance"
            ...
            <div className={styles.field}>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Sub-Saharan Africa, Southeast Asia"
              />
            </div>
          </div>
        </div>
